        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr v-for="eachStudent in allStudents" :key="eachStudent.id">
                    ...
                    <td>
                        <router-link :to="'/edit-student/' + eachStudent.id" class="btn btn-success btn-sm btn-rounded"><i
                                class="fa fa-edit"></i></router-link>
                        <router-link :to="'/del-student/' + eachStudent.id" class="btn btn-danger  btn-sm btn-rounded"><i
                                class="fa fa-trash"></i></router-link>
                    </td>
                </tr>
